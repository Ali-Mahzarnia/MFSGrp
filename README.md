...
The [pacman](https://cran.r-project.org/web/packages/pacman/index.html) is needed only for the below alternative installation methods (development version)  ```install.packages("pacman") ```
